...
var mapbox = exports.mapbox = function mapbox(locations) {
  // access token
  mapboxgl.accessToken = 'pk.eyJ1Ijoia2FyZWVtLXRhcmVrIiwiYSI6ImNtM3VsYzBrdjBqMW8ycXIwMzlmcGVyeDUifQ.zjxdDkRIOX17-le61Sq6uA';
  // get map on website
  ...
  locations.forEach(function (locat) {
    ...
    new mapboxgl.Marker({
      element: pin,
      anchour: 'bottom'
    }).setLngLat(locat.coordinates).addTo(map);

    // craete popup on location
    new mapboxgl.Popup({
      offset: 15
    }).setLngLat(locat.coordinates).setHTML("<p>Day ".concat(locat.day, ":").concat(locat.description, "</p>")).addTo(map);
...
exports.hideAlert = exports.default = void 0;
...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  var marker = "<div class='alert alert--".concat(type, "'>").concat(msg, "</div>");
  document.querySelector('body').insertAdjacentHTML('afterbegin', marker);
  window.setTimeout(function () {
    hideAlert();
  }, 5000);
};
var _default = exports.default = showAlert;
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.default)('success', "".concat(res.data.status, " \uD83D\uDC4D"));
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
        ...
        case 7:
          ...
          (0, _alerts.default)('error', "\u274C ".concat(_context.t0.response.data.message));
        case 10:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') {
            (0, _alerts.default)('success', 'Loggedout 👍');
            setTimeout(function () {
        ...
        case 7:
          ...
          (0, _alerts.default)('error', 'Error Logingout, please try again');
        case 10:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          // console.log(res);
          if (res.data.status === 'success') {
            (0, _alerts.default)('success', 'signed up 👍');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
        ...
        case 7:
          ...
          _context.t0 = _context["catch"](0);
          // console.log(err.response.data.message);
          (0, _alerts.default)('error', 'Duplaction Error. There is email already exist ❌');
        case 10:
        case "end":
          return _context.stop();
      }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"validationLogin.js":[function(require,module,exports) {
"use strict";
...
var validationLogin = exports.validationLogin = function validationLogin() {
  ...
  email.oninput = function () {
    var regex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
    return regex.test(email.value) ? email.style.borderBottom = '3px solid #55c57a' : email.style.borderBottom = '3px solid orangered';
  };
};
},{}],"validationSignup.js":[function(require,module,exports) {
"use strict";
...
var validationSignup = exports.validationSignup = function validationSignup() {
  var password = document.querySelector('#password');
  var email = document.querySelector('input[type=email]');
...
exports.chargeCreditcard = void 0;
var _axios = _interopRequireDefault(require("axios"));
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = Stripe('pk_test_51QpBlX6LKyuAYvJiGsoTSXM8iBfIVc98Wei26OLBgz32r5MsLgFYgQpkW9M3V7PKRzo1X7pGsn0IGMqzuxtuL5qU00GLItjde3');
var chargeCreditcard = exports.chargeCreditcard = /*#__PURE__*/function () {
  ...
  return function chargeCreditcard(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var _validationLogin = require("./validationLogin");
var _validationSignup = require("./validationSignup");
...
if (map) {
  ...
  (0, _mapbox.mapbox)(locations);
}
var form = document.querySelector('.form__content');
var name = document.getElementById('name');
if (form) {
  if (!name) {
    (0, _validationLogin.validationLogin)();
  } else {
    (0, _validationSignup.validationSignup)();
  }
  form.addEventListener('submit', function (e) {
    ...
    if (!name) {
      ...
      (0, _signup.signup)(_name, email, password, passwordConfirm);
    }
  });
}
var logoutBtn = document.querySelector('.logout');
if (logoutBtn) logoutBtn.addEventListener('click', _login.logout);
var dataForm = document.querySelector('.right_details');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          password = document.getElementById('new_pasword').value;
